...
<img src="logo.jpg" alt="IE332 Group Logo" class="logo"/>
...
<div id="bottomRightContainer"></div>
</div>
</div>
</div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Split left and center containers
        Split(["#leftContainer", "#centerContainer"], {
            sizes: [50, 50],
            minSize: 100,
            gutterSize: 3,
            cursor: "col-resize",
        ...
        // Split center and right containers
        Split(["#centerContainer", "#rightContainer"], {
            sizes: [70, 30],
            minSize: 100,
            gutterSize: 3,
            cursor: "col-resize",
        ...
        // Split top right and bottom right containers
...
echo "<script>document.getElementById('avgP').innerText = 'The average purchase price is: " . $averagePrice . "
...
which will
 ...
 eventually be an EmployeeID or ProductID to view details about
...
backgroundColor: "rgb(50, 224, 224)",
borderColor: "rgb(50, 224, 224)",
borderWidth: 1
}]
},
options: {
